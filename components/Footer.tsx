...
export default function Footer() {
  return (
    <footer className="mx-auto grid max-w-[1280px] 2xl:max-w-[1440px] grid-cols-1 gap-10 px-5 pb-10 pt-5 sm:grid-cols-2 md:px-10 lg:grid-cols-[1.4fr_1fr_1fr_1.3fr]">
      <div>
