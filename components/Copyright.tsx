...
export default function Copyright() {
  return (
    <div className="border-t border-[#e7ebf1] bg-white text-[13px] text-[#5a6474]">
      <div className="mx-auto flex max-w-[1280px] 2xl:max-w-[1440px] flex-col items-center gap-2 px-5 py-[18px] text-center sm:flex-row sm:justify-between sm:text-left md:px-10">
