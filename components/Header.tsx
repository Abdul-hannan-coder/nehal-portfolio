...
export default function Header({ active = "/", variant = "dark" }: HeaderProps) {
  ...
  const inner =
    variant === "light" ? (
      <header className="mx-auto flex max-w-[1280px] 2xl:max-w-[1600px] items-center justify-between px-5 py-[18px] md:px-10">
      ...
      <div className="mx-auto max-w-[1280px] 2xl:max-w-[1600px] px-4 pb-2 pt-[18px] sm:px-6 lg:px-10">
