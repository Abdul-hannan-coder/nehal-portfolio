...
export default function LetsConnect() {
  return (
    <div className="mx-auto mb-10 mt-14 flex max-w-[1280px] 2xl:max-w-[1600px] flex-col items-start gap-5 px-5 sm:flex-row sm:items-center sm:justify-between md:px-10">
