...
export default function HomePage() {
  return (
    <ClientEnhance>
      ...
      {/* HERO */}
      <div id="home" className="mx-auto mt-5 grid max-w-[1120px] scroll-mt-[90px] grid-cols-1 items-stretch gap-x-[50px] 2xl:gap-x-[80px] gap-y-12 px-5 pt-[36px] md:px-10 lg:grid-cols-[1.15fr_0.88fr]">
      ...
      >
        <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-center gap-16 lg:grid-cols-[460px_1fr] lg:gap-[70px] 2xl:grid-cols-[540px_1fr] 2xl:gap-[100px]">
        ...
        <StatsStrip inverted className="mx-auto mt-16 max-w-[1120px]" />
      </div>
      ...
      */}
      ...
      {/* TESTIMONIALS */}
      {/* 
      <div id="testimonials" className="mx-auto my-20 md:my-28 max-w-[1120px] scroll-mt-[90px] px-5 md:px-10 text-center">
        <div className="mb-2 text-[14px] font-semibold text-gold tracking-wider uppercase">
